...
<html>
  <head>
    ...
    <link rel='stylesheet' href='styles/delete-photo.css'>

    <title>delete-photograph-admin-page-photograpy-malcom-lismore</title>
      ...
      <div class="form-container">
        ...
        <form class="form" action="php-files/admin-functions.php" method="post" enctype="multipart/form-data">
          ...
          <div>
            ...
            <input type="text" id="name" name="name" placeholder="The photography name" required value="<?php echo $data['img_name']; ?>">
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" id="description" name="description" placeholder="Description of the photography" value="<?php echo $data['img_desc']; ?>">
          </div>
          <div class="btn-section">
            <button type="submit" class="btn-delete" name="btn-delete">
              Delete
            </button>
          </div>
        </form>
